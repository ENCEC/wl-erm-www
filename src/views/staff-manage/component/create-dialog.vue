 ...
 * @LastEditors: Hongzf
 * @LastEditTime: 2022-08-01 15:22:19
      ...
      >
        <div class="form-wrap">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="户籍地址:" prop="mobi2le">
                <el-input
                  v-model="formData.mob2ile"
                  placeholder="请输入户籍地址"
                  clearable
                />
              </el-form-item>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="婚姻状况:" prop="staffDutyCode2">
                <el-select
                  v-model="formData.staffDutyCode2"
                  placeholder="请选择婚姻状况"
                  clearable
                  class="input-width"
                >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="学历:" prop="projectId2">
                <el-select
                  v-model="formData.projectId2"
                  placeholder="请选择学历"
                  clearable
            ...
            <el-col :span="12">
              <el-form-item label="毕业时间:" prop="entryDate2">
                <el-date-picker
                  v-model="formData.entryDate2"
                  format="yyyy-MM-dd"
                  class="input-width"
                  placeholder="请选择入职时间"
                  clearable
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="毕业学校:" prop="emai2l">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="在校专业:" prop="email3">
                <el-input
                  v-model="formData.email"
                  placeholder="请输入在校专业"
                  clearable
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="入职部门:" prop="entryDate">
                <el-select
                  v-model="formData.entryDate"
                  placeholder="请选择入职部门"
                  clearable
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="岗位职称:" prop="staffDutyCode">
                <el-select
                  v-model="formData.staffDutyCode"
                  placeholder="请选择岗位职称"
                  clearable
